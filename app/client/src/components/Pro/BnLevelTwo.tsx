...
const BnLevelTwo = () => {
  ...
  // isBuyerMaker = True means it's a market sell
            ...
            {Array.isArray(tape) ? (
              tape
                .map((each: any, idx: any) => {
                  ...
                  return (
                    <tbody key={idx}>
                      <tr className={each.isBuyerMaker ? "bg-red" : "bg-green"}>
                        ...
                        <td style={{ width: "25%" }}>
                          {Number(each.qty).toFixed(4)}
                        </td>
                        <td style={{ width: "20%" }}>
                          {(Number(each.price) * each.qty).toFixed(0)}
                        </td>
                      </tr>
                    </tbody>
                  );
